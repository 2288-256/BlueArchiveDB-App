...
class ViewController: UIViewController,UICollectionViewDataSource,
    ...
    override func viewDidLoad() {
        ...
        let CharacterImageHeight = self.CharacterImage.frame.size.height
    ...
    @IBAction func downloadZip(){
        ...
        case .cellular , .wifi:
            ...
            let url:NSURL = NSURL(string: "https://github.com/lonqie/SchaleDB/archive/refs/heads/main.zip")!
    ...
    @objc func CharacterTapped(_ sender: Any) {
