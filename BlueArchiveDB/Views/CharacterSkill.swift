...
class CharacterSkill: UIViewController
{
	...
	override func viewDidLoad()
	{
		...
		{let SkillArray = SkillArrays[i]
            var mainView = LoadSkill.shared.loadAllSkillCell(studentStatus:studentStatus,skillIndex: i, SkillArray: SkillArray, SkillCellPosition: SkillCellPosition,action: #selector(sliderDidChangeValue(_:)),target: self)
            //returnでmainViewを返す
